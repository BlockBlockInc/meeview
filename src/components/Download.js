...
function Download(props) {
  ...
  const submitForm = async (event) => {
    ...
    var uploadImage = firebaseStorageRef
      .ref(`/gallery/${"galleryImage_" + randomImageUID}`)
  ...
  return (
    <div className="absolute z-10 inset-x-0 bottom-5">
      <div className="flex justify-center">
        <Suspense>
          <button
            className="bg-gray-900 hover:bg-gray-800 focus:outline-none text-white font-bold py-2 px-10 rounded-lg"
            onClick={handleClick}
          >
            Cheese 📸
          </button>
        ...
        >
          <Fade in={open}>
            <div className={classes.paper}>
              <button
                className="text-white font-nimbus text-lg hover:text-yellow-300"
                onClick={takeScreenshot}
              >
                👉 Download Your Screenshot!
              </button>
              <h1 className="text-white font-nimbus text-md mt-6">
                👉 Submit your picture and pose to our community gallery!
              </h1>
              ...
              <form className="mt-4 rounded" onSubmit={submitForm}>
                <div className="flex flex-col space-y-4">
                  <input
                    ...
                    value={submitterName}
                    onChange={handleSubmitterNameChanges}
                  />
                  <input
                    className="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    type="text"
                    placeholder="What's your Meebit's name..."
                    value={meebitName}
                    onChange={handleMeebitNameChanges}
                  />
                  <input
                    className="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    type="text"
                    ...
                    value={poseName}
                    onChange={handlePoseNameChanges}
                  />
                  <button
        ...
        <Snackbar
          ...
          autoHideDuration={3000}
        >
          <Alert onClose={handleSnackBarErrorClose} severity="failure">
